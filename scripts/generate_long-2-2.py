...
# load tokenizer
tokenizer = LEDTokenizer.from_pretrained("./long-ft-pubmed/checkpoint-250/")
model = LEDForConditionalGeneration.from_pretrained("./long-ft-pubmed/checkpoint-250/").to(device)
...
write_data_txt(result["predicted_abstract"], "long-ft-pubmed-grt-AP")