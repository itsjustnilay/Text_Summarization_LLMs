...
plos_scores = evaluate(
  os.path.join(submit_dir, 'long-ft-arvix_pubmed-grt-AP_f50.txt'),  
  os.path.join(truth_dir, 'arvix_test_50.jsonl'),
  )
write_scores(plos_scores, os.path.join(output_dir, 'long-ft-arvix_pubmed-grt-AP_f50-eval.txt'))
