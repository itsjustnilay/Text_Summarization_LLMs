...
# load tokenizer
tokenizer = LEDTokenizer.from_pretrained("./long-ft-arxiv_pubmed/checkpoint-250/")
model = LEDForConditionalGeneration.from_pretrained("./long-ft-arxiv_pubmed/checkpoint-250/").to(device)
...
write_data_txt(result["predicted_abstract"], "long-ft-arxiv_pubmed-grt-AP")